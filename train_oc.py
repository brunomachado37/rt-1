...
from data.maniskill.dataset import build_maniskill_traj_dataset
from data.robocasa.lang_utils import language_encoder_factory


@hydra.main(version_base=None, config_path="conf", config_name="config_maniskill")
def train(config):
    ...
    training_set, validation_set = build_maniskill_traj_dataset(config.data) # TODO : check the config format
