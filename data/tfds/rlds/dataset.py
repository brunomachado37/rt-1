...
from data.tfds.rlds import obs_transforms, traj_transforms
from data.tfds.rlds.utils import goal_relabeling, task_augmentation
from data.tfds.rlds.utils.data_utils import (
    NormalizationType,
    allocate_threads,
...
def make_dataset_from_rlds(
    ...
    *,
    ...
    Returns:
        ...
        - is_terminal                   # terminal flag, present if `is_terminal` is present in the dataset
    """
    ...
    def restructure(traj):
        ...
        traj = {
            ...
            "is_terminal": traj["is_terminal"] if "is_terminal" in traj else tf.repeat(False, traj_len),
        }
